...
import {FastifyRequest, FastifyReply, FastifyInstance, RouteOptions, FastifySchema} from 'fastify'
 ...
 */
export default async function status (fastify:FastifyInstance, opts:RouteOptions) {
